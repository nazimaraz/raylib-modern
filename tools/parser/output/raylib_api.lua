return {
  ...
  functions = {
    ...
    },
    {
      ...
      returnType = "void",
      params = {
        {type = "TraceLogLevel", name = "logLevel"},
        {type = "const char *", name = "text"},
        {type = "...", name = "args"}
      }
    },
    ...
    },
    {
      ...
      description = "Encode data to Base64 string (includes nullptr terminator), memory must be MemFree()",
      returnType = "char *",
      params = {
        {type = "const unsigned char *", name = "data"},
        {type = "int", name = "dataSize"},
    ...
    },
    {
      ...
      description = "Decode Base64 string (expected nullptr terminated), memory must be MemFree()",
      returnType = "unsigned char *",
      params = {
        {type = "const char *", name = "text"},
        {type = "int *", name = "outputSize"}
    ...
    },
    {
      ...
      description = "Load automation events list from file, nullptr for empty list, capacity = MAX_AUTOMATION_EVENTS",
    ...
    },
    {
      ...
      params = {
        {type = "Image *", name = "image"},
        {type = "PixelFormat", name = "newFormat"}
      }
    },
    {
      name = "ImageToPOT",
    ...
    },
    {
      ...
      params = {
        {type = "Image", name = "image"},
        {type = "CubemapLayout", name = "layout"}
      }
    },
    {
    ...
    },
    {
      ...
      params = {
        {type = "Texture2D", name = "texture"},
        {type = "TextureFilter", name = "filter"}
      }
    },
    {
      name = "SetTextureWrap",
    ...
    {
      name = "LoadFontEx",
      description = "Load font from file with extended parameters, use nullptr for codepoints and 0 for codepointCount to load the default character set, font size is provided in pixels height",
      returnType = "Font",
      params = {
        {type = "const char *", name = "fileName"},
        {type = "int", name = "fontSize"},
